...
interest_rate.grid(row = 1, column = 2, padx = 5)
num_years.grid(row = 2, column = 2, padx = 5)
loan_amount.grid(row = 3, column = 2, padx = 5)
...
monthly_result.grid(row = 4, column = 2, padx = 5, sticky = E)
total_result.grid(row = 5, column = 2, padx = 5, sticky = E)
