...
public class ExceptionMain {
    public static void main(String[] args) {
        ...
        //IPlayable iPlayable = new IPlayable();//cannot init an object from an Interface
        IPlayable personA = new IPlayable() {
            //personA is an "anonymous object", which implements IPlayable
            @Override
