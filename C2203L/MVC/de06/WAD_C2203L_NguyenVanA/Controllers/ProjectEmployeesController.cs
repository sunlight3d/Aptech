...
using WAD_C2203L_NguyenVanA.Models;
...
namespace WAD_C2203L_NguyenVanA.Controllers
{
    public class ProjectEmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeeId,ProjectId,Tasks")] ProjectEmployee projectEmployee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeId,ProjectId,Tasks")] ProjectEmployee projectEmployee)
        {
            if (ModelState.IsValid)
            {
