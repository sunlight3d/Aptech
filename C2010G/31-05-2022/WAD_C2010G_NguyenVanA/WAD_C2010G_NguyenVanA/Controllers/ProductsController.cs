...
namespace WAD_C2010G_NguyenVanA.Controllers
{
    public class ProductsController : Controller
    {
                ...
                string searchString, int? page)
        {
            ...
            var products = db.Products.Include(p => p.Category); //select *//
            ...
            int pageSize = 3;
            int pageNumber = (page ?? 1); //default value, nil coalescing, elvis operator
        ...
        public ActionResult Edit(int? id)
        {
            ...
            Product product = db.Products.Find(id);//linq, orm
