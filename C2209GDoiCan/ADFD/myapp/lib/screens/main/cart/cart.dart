    ...
    return Scaffold(
      ...
      body: BlocBuilder<CartBloc, CartState>(
        builder: (context, state) {
          ...
          final int totalQuantity = cartItems.fold(0, (sum, item) => sum + item.quantity);
                ...
                child: Column(
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        const Text("Tổng số lượng:", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                        Text("$totalQuantity sản phẩm", style: const TextStyle(fontSize: 16)),
                      ],
                    ),
                    const SizedBox(height: 5),
                    Row(
