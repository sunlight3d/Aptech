...
namespace PhotoSharingApplication.Controllers
{
    public class PhotoController : Controller
    {
        ...
        // GET: /Photo/5
        // GET: /Photo/Details/5
        public ActionResult Details(int id = 0) //action
        {
            ...
            return View("Details", photo);//Views/Details.cshtml
        }
        ...
        public ActionResult Create()
        {
            ...
            return View(newPhoto);//Photo/Create.cshtml
        }
